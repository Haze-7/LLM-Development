...
# Example queries:
#Query: Use Qwen to explain quantum computing
# OpenAI will call qwen_chat tool

#Query: What's 2+2?
# OpenAI might just answer directly (no tool needed)

#Query: Ask Qwen to write a haiku about coding
# OpenAI will call qwen_chat with that prompt